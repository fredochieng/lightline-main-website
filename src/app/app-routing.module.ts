...
import { AccreditationsComponent } from './components/pages/accreditations/accreditations.component';
...
const routes: Routes = [
    ...
    //l{path: 'index-3', component: HomeDemoThreeComponent},
    ...
    {path: 'approach', component: ServicesDetailsPageComponent},
    ...
    {path: 'offering', component: WorkDetailsPageComponent},
